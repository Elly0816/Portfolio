...
return <div style={{backgroundImage: project.img}} className={`${khandFont.className} w-96 h-96 project rounded-lg flex flex-col py-3 px-3 border-solid border-black shadow-lg my-3 mx-3`}>
