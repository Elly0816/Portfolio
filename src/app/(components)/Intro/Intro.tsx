                ...
                <div>
                    ...
                    <div className={`flex flex-row text-current`}>
                        <Link
                            ...
                            className="mx-3"
                            href={"https://www.github.com/Elly0816"}
                            about="Link to Eleazar's github"
                        >
                            <Image
                                src={"/github.png"}
                        ...
                        <Link
                            title="Eleazar's linkedIn"
                            className="mx-3"
                            href={"https://www.linkedin.com/in/eleazarudo/"}
                            about="Link to Eleazar's linkedin"
                        >
                            <Image
                                src={"/linkedin.png"}
                        ...
                        <Link
                            title="Eleazar's Twitter"
                            className="mx-3"
                            href={"https://www.x.com/elly0x"}
                            about="Link to Eleazar's X profile"
                        >
                            <Image
                                src={"/x.png"}
