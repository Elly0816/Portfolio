...
export interface projectTheme {
    theme:
        | ["bg-slate-100", "text-gray-900", "shadow-black", "border-black"]
        | [
              //   "dark:bg-gray-900",
              "bg-gray-900",
              //   "dark:text-white",
...
const useDarkSide: () => [
    mainTheme["theme"],
    Dispatch<SetStateAction<mainTheme["theme"]>>
] = () => {
    ...
    const [theme, setTheme] = useState<mainTheme["theme"]>(
        typeof window !== "undefined" &&
            (localStorage.getItem("theme") as mainTheme["theme"])
            ? (localStorage.getItem("theme") as mainTheme["theme"])
            : "dark"
    );
    ...
    useEffect(() => {
        ...
        const header =
            window.document.documentElement.getElementsByClassName("header")[0];
        const projects =
            window.document.documentElement.getElementsByClassName("project");
